...
export const config = {
    ...
    LEADER_LOCK_KEY:process.env.LEADER_LOCK_KEY,
    CRON_TICK_INTERVAL_MS:process.env.CRON_TICK_INTERVAL_MS,
    KAFKA_DLQ_TOPIC:process.env.KAFKA_DLQ_TOPIC,
    RECONCILIATION_POLL_INTERVAL_MS:process.env.RECONCILIATION_POLL_INTERVAL_MS,
    DEFAULT_JOB_TIMEOUT_SECONDS:process.env.DEFAULT_JOB_TIMEOUT_SECONDS,
};